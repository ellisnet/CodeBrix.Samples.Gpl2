...
public class PresetPolyphoneTests
{
    ...
    private static void AreEqual(PolyphoneRegion polyphoneRegion, PresetRegion meltyRegion)
    {
        ...
        polyphoneRegion.TuningCents.Should().Be(meltyRegion.FineTune);
        polyphoneRegion.ScaleTuning.Should().Be(meltyRegion.ScaleTuning);
        polyphoneRegion.FilterCutoffX.ShouldBeApproximately(meltyRegion.InitialFilterCutoffFrequency, 0.001);
        polyphoneRegion.FilterResonanceX.ShouldBeApproximately(meltyRegion.InitialFilterQ, 0.1);
        polyphoneRegion.VolEnvDelayX.ShouldBeApproximately(meltyRegion.DelayVolumeEnvelope, 0.001);
        polyphoneRegion.VolEnvAttackX.ShouldBeApproximately(meltyRegion.AttackVolumeEnvelope, 0.001);
        polyphoneRegion.VolEnvHoldX.ShouldBeApproximately(meltyRegion.HoldVolumeEnvelope, 0.001);
        polyphoneRegion.VolEnvDecayX.ShouldBeApproximately(meltyRegion.DecayVolumeEnvelope, 0.001);
        polyphoneRegion.VolEnvSustainDb.ShouldBeApproximately(meltyRegion.SustainVolumeEnvelope, 0.1);
        polyphoneRegion.VolEnvReleaseX.ShouldBeApproximately(meltyRegion.ReleaseVolumeEnvelope, 0.001);
        ...
        polyphoneRegion.ModEnvDelayX.ShouldBeApproximately(meltyRegion.DelayModulationEnvelope, 0.001);
        polyphoneRegion.ModEnvAttackX.ShouldBeApproximately(meltyRegion.AttackModulationEnvelope, 0.001);
        polyphoneRegion.ModEnvHoldX.ShouldBeApproximately(meltyRegion.HoldModulationEnvelope, 0.001);
        polyphoneRegion.ModEnvDecayX.ShouldBeApproximately(meltyRegion.DecayModulationEnvelope, 0.001);
        polyphoneRegion.ModEnvSustainP.ShouldBeApproximately(meltyRegion.SustainModulationEnvelope, 0.1);
        polyphoneRegion.ModEnvReleaseX.ShouldBeApproximately(meltyRegion.ReleaseModulationEnvelope, 0.001);
        ...
        polyphoneRegion.ModLfoDelayX.ShouldBeApproximately(meltyRegion.DelayModulationLfo, 0.001);
        polyphoneRegion.ModLfoFreqX.ShouldBeApproximately(meltyRegion.FrequencyModulationLfo, 0.001);
        ...
        polyphoneRegion.VibLfoDelayX.ShouldBeApproximately(meltyRegion.DelayVibratoLfo, 0.001);
        polyphoneRegion.VibLfoFreqX.ShouldBeApproximately(meltyRegion.FrequencyVibratoLfo, 0.001);
