...
namespace ManagedDoom
{
	public sealed class DoomGame
	{
		...
		private void DoLoadGame()
		{
			...
			var data = ConfigUtilities.Storage.LoadSaveSlot(loadGameSlotNumber);
			if (data == null)
			{
				return;
			}

			SaveAndLoad.Load(this, data);
		}
		...
		private void DoSaveGame()
		{
			...
			var data = SaveAndLoad.Save(this, saveGameDescription);
			ConfigUtilities.Storage.SaveSaveSlot(saveGameSlotNumber, saveGameDescription, data);
