...
public class MainViewModel : SimpleViewModel
{
    ...
    private string _currentPageUrl = WolfensteinAssetCatalog.DefaultBrowseUrl;
    ...
    private async Task InstallAssetsAsync(string url)
    {
        ...
        try
        {
            ...
            await WolfensteinAssetPipeline.InstallFromUrlAsync(url, _currentPageUrl, _assetsFolder,
